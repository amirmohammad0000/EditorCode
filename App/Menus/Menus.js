...
let TerminalClick = document.querySelector(".div_terminal");
...
TerminalClick.addEventListener("click", () => {
...
const FuncStatusBar = () => {
    if (stateStatusBar === true) {
        ...
        StatusBarInMenu.style.bottom = "-25px";
...
let ContextMenu = new ElectronMenusRemote.MenuItem({
    label: "useful",
    submenu: [
        {
            role: "undo",
...
let ContextMenus = ElectronMenusRemote.Menu.buildFromTemplate([ContextMenu]);
